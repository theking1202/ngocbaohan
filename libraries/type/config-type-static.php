...
// $config['static'][$nametype]['title_main'] = "Tại sao chọn chúng tôi";
...
// $config['static'][$nametype]['width1'] = 150;

// $config['static'][$nametype]['height1'] = 150;

// $config['static'][$nametype]['width'] = 600;

// $config['static'][$nametype]['height'] = 290;
