                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                ...
                                                <p style="margin:4px 0;font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#444;line-height:18px;font-weight:normal">You received a contact letter from a customer <span style="text-transform:capitalize">{emailTitleSender}</span> at website {emailCompanyWebsite}.</p>
