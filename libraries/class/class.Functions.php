...
*/
...

    {
        ...
        if (isset($_FILES[$file]) && !$_FILES[$file]['error']) {
            ...
            if ($_FILES[$file]['size'] > $MaxSize * 10485760000) {
...

    {
        ...
        if ($id) {
            ...
            $temps = $this->d->rawQuery("select id_size from #_product where id = ?", array($id));
        ...
        $str = '<select id="dataSize" name="data[id_size]" class="select2">';
