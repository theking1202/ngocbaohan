...
function editMan()
{
    ...
    if (empty($id)) {
        $func->transfer(khongnhanduocdulieu, "index.php?com=tags&act=man&type=" . $type . "&p=" . $curPage, false);
    } else {
        $item = $d->rawQueryOne("select * from #_tags where id = ? and type = ? limit 0,1", array($id, $type));

        if (empty($item)) {
            $func->transfer(dulieukhongcothuc, "index.php?com=tags&act=man&type=" . $type . "&p=" . $curPage, false);
        }
    }
}
...
function saveMan()
{
    global $d, $langadmin, $curPage, $func, $flash, $config, $com, $type;
    ...
    if ($id) {
        ...
        if ($d->update('tags', $data)) {
            ...
            $func->transfer(capnhatdulieuthanhcong, "index.php?com=tags&act=man&type=" . $type . "&p=" . $curPage);
        } else {
            $func->transfer(capnhatdulieubiloi, "index.php?com=tags&act=man&type=" . $type . "&p=" . $curPage, false);
        }
    } else {
        ...
        if ($d->insert('tags', $data)) {
            ...
            $func->transfer(luudulieuthanhcong, "index.php?com=tags&act=man&type=" . $type . "&p=" . $curPage);
        } else {
            $func->transfer(luudulieubiloi, "index.php?com=tags&act=man&type=" . $type . "&p=" . $curPage, false);
        }
    }
}
...
function deleteMan()
{
    global $d, $langadmin, $curPage, $func, $com, $type;
    ...
    if ($id) {
        ...
        if (!empty($row)) {
            ...
            $func->transfer(xoadulieuthanhcong, "index.php?com=tags&act=man&type=" . $type . "&p=" . $curPage);
        } else {
            $func->transfer(xoadulieubiloi, "index.php?com=tags&act=man&type=" . $type . "&p=" . $curPage, false);
        }
