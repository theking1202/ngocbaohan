                                        ...
                                        <?php if (isset($config['news'][$type]['copy']) && $config['news'][$type]['copy'] == true) { ?>
                                            <div class="dropdown">
                                                ...
                                                <ul aria-labelledby="dropdownCopy" class="dropdown-menu border-0 shadow">
                                                    <li><a href="#" class="dropdown-item copy-now" data-id="<?= $items[$i]['id'] ?>" data-table="news" data-copyimg="<?= $copyImg ?>"><i class="far fa-caret-square-right text-secondary mr-2"></i><?=saochepngay?></a></li>
                                ...
                                <td class="align-middle text-center text-md text-nowrap">
                                    <?php if (isset($config['news'][$type]['copy']) && $config['news'][$type]['copy'] == true) { ?>
                                        <div class="dropdown d-inline-block align-middle">
                                            ...
                                            <ul aria-labelledby="dropdownCopy" class="dropdown-menu border-0 shadow">
                                                <li><a href="#" class="dropdown-item copy-now" data-id="<?= $items[$i]['id'] ?>" data-table="news"><i class="far fa-caret-square-right text-secondary mr-2"></i><?=saochepngay?></a></li>
