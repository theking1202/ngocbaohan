...
<section class="content">
    <div class="card-footer text-sm sticky-top">
        ...
        <div class="form-inline form-search d-inline-block align-middle ml-3">
            <div class="input-group input-group-sm">
                <input class="form-control form-control-navbar text-sm" type="search" id="keyword" placeholder="<?=timkiem?>" aria-label="<?=timkiem?>" value="<?= (isset($_GET['keyword'])) ?: '' ?>" onkeypress="doEnter(event,'keyword','<?= $linkMan ?>')">
    ...
    <div class="card card-primary card-outline text-sm mb-0">
        <div class="card-header">
            <h3 class="card-title"><?=danhsach?> <?= $config['news'][$type]['title_main_sub'] ?></h3>
        </div>
