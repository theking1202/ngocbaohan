                ...
                <div class="row">
                    ...
                    <?php if (isset($config['setting']['hotline2']) && $config['setting']['hotline2'] == true) { ?>
                        <div class="form-group col-md-4 col-sm-6">
                            ...
                            <input type="text" class="form-control text-sm" name="data[options][hotline2]" id="hotline2" placeholder="Hotline 2" value="<?= (!empty($flash->has('hotline2'))) ? $flash->get('hotline2') : @$options['hotline2'] ?>" required>
                        </div>
                    <?php } ?>
                    ...
                    <?php if (isset($config['setting']['tiktok']) && $config['setting']['tiktok'] == true) { ?>
                        <div class="form-group col-md-4 col-sm-6">
                            ...
                            <input type="text" class="form-control text-sm" name="data[options][tiktok]" id="tiktok" placeholder="tiktok" value="<?= (!empty($flash->has('tiktok'))) ? $flash->get('tiktok') : @$options['tiktok'] ?>" required>
                        </div>
                    <?php } ?>
                    ...
                    <?php if (isset($config['setting']['youtube']) && $config['setting']['youtube'] == true) { ?>
                        <div class="form-group col-md-4 col-sm-6">
                            ...
                            <input type="text" class="form-control text-sm" name="data[options][youtube]" id="youtube" placeholder="Youtube" value="<?= (!empty($flash->has('youtube'))) ? $flash->get('youtube') : @$options['youtube'] ?>">
                        </div>
                    <?php } ?>
