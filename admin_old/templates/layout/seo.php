                    ...
                    <div class="tab-pane fade show <?= ($k == 'vi') ? 'active' : '' ?>" id="tabs-seolang-<?= $k ?>" role="tabpanel" aria-labelledby="tabs-lang">
                        <div class="form-group">
                            <div class="label-seo">
                                ...
                                <strong class="count-seo"><span><?= strlen(htmlspecialchars(@$seoDB['title' . $k]?:'')) ?></span>/100 <?=kytu?></strong>
                            </div>
                        ...
                        <div class="form-group">
                            <div class="label-seo">
                                ...
                                <strong class="count-seo"><span><?= strlen(htmlspecialchars(@$seoDB['keywords' . $k]?:'')) ?></span>/100 <?=kytu?></strong>
                            </div>
                        ...
                        <div class="form-group">
                            <div class="label-seo">
                                ...
                                <strong class="count-seo"><span><?= strlen(htmlspecialchars(@$seoDB['description' . $k] ?: '')) ?></span>/300 <?=kytu?></strong>
                            </div>
