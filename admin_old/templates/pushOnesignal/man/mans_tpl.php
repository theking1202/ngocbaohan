    ...
    <div class="container-fluid">
        <div class="row">
            <ol class="breadcrumb float-sm-left">
                ...
                <li class="breadcrumb-item active"><?=quanlythongbaoday?></li>
            </ol>
        </div>
    </div>
</section>
...
<section class="content">
    ...
    <div class="card card-primary card-outline text-sm mb-0">
        <div class="card-header">
            <h3 class="card-title"><?=danhsachthongbaoday?></h3>
        </div>
            ...
            <table class="table table-hover">
                <thead>
                    <tr>
                        ...
                        <th class="align-middle text-center"><?=daytin?></th>
                        ...
                        <?php for ($i = 0; $i < count($items); $i++) { ?>
                            <tr>
                                ...
                                <td class="align-middle text-center text-md text-nowrap">
                                    <a class="btn btn-sm bg-gradient-success text-white" id="push-onesignal" data-url="index.php?com=pushOnesignal&act=sync&id=<?= $items[$i]['id'] ?>" title="Đẩy tin"><i class="fas fa-paper-plane mr-2"></i><?=daytin?></a>
                                </td>
                                <td class="align-middle text-center text-md text-nowrap">
                                    <a class="text-primary mr-2" href="<?= $linkEdit ?>&id=<?= $items[$i]['id'] ?>" title="<?=chinhsua?>"><i class="fas fa-edit"></i></a>
                                    <a class="text-danger" id="delete-item" data-url="<?= $linkDelete ?>&id=<?= $items[$i]['id'] ?>" title="<?=xoa?>"><i class="fas fa-trash-alt"></i></a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
