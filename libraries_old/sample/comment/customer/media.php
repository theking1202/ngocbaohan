<div class="carousel slide carousel-comment-media mt-2" id="carousel-comment-media-<?= $params['lists']['id'] ?>" data-bs-ride="carousel" data-bs-touch="true" data-interval="false">
    <ol class="carousel-indicators flex-wrap">
        <?php if (!empty($params['lists']['video'])) { ?>
            <li class="position-relative transition me-1" data-bs-target="#carousel-comment-media-<?= $params['lists']['id'] ?>" data-bs-slide-to="0" data-id="video">
        ...
        <?php if (!empty($params['lists']['photo'])) {
            foreach ($params['lists']['photo'] as $k_photo => $v_photo) { ?>
                <li class="transition me-1" data-bs-target="#carousel-comment-media-<?= $params['lists']['id'] ?>" data-bs-slide-to="<?= (!empty($params['lists']['video'])) ? ($k_photo + 1) : $k_photo ?>" data-id="<?= $v_photo['id'] ?>">
    ...
    <div class="carousel-inner">
        ...
        <div class="carousel-control">
            <button class="carousel-control-prev" type="button" data-bs-target="#carousel-comment-media-<?= $params['lists']['id'] ?>" data-bs-slide="prev">
                <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                <span class="visually-hidden">Previous</span>
            </button>
            <button class="carousel-control-next" type="button" data-bs-target="#carousel-comment-media-<?= $params['lists']['id'] ?>" data-bs-slide="next">
                <span class="carousel-control-next-icon" aria-hidden="true"></span>
                <span class="visually-hidden">Next</span>
            </button>
            <?php /*
            <a class="carousel-control-prev transition" href="#carousel-comment-media-<?= $params['lists']['id'] ?>" role="button" data-bs-slide="prev">
                <span>
            ...
            <a class="carousel-control-next transition" href="#carousel-comment-media-<?= $params['lists']['id'] ?>" role="button" data-bs-slide="next">
                <span>
