<form class="mt-3" id="form-reply" action="" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        <textarea class="form-control text-sm" placeholder="<?=vietcautraloicuaban?>" name="dataReview[content]" id="reply-content" data-name="@<?= $params['lists']['fullname'] ?>:" rows="5"></textarea>
    </div>
    <div class="text-right">
        <button type="submit" class="btn btn-sm btn-warning py-2 px-3"><?=guitraloi?></button>
        <button type="button" class="btn btn-sm btn-secondary btn-cancel-reply py-2 px-3"><?=huybo?></button>
    </div>
