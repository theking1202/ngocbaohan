                        ...
                        <div class="information-cart">
                            ...
                            <div class="row row-10">
                                ...
                                <div class="input-cart col-md-6 mg-col-10">
                                    ...
                                    <div class="form-floating form-floating-cus">
                                        ...
                                        <input type="text" class="form-control text-sm" id="fullname" name="dataOrder[fullname]" placeholder="<?= hoten ?>" value="<?= (!empty($flash->has('fullname'))) ? $flash->get('fullname') : ((!empty($_SESSION[$loginMember]['fullname'])) ? $_SESSION[$loginMember]['fullname'] : '') ?>" required />
                                ...
                                <div class="input-cart col-md-6 mg-col-10">
                                    ...
                                    <div class="form-floating form-floating-cus">
                                        ...
                                        <input type="number" class="form-control text-sm" id="phone" name="dataOrder[phone]" placeholder="<?= dienthoai ?>" value="<?= (!empty($flash->has('phone'))) ? $flash->get('phone') : ((!empty($_SESSION[$loginMember]['phone'])) ? $_SESSION[$loginMember]['phone'] : '') ?>" required />
                            ...
                            <div class="input-cart">
                                ...
                                <div class="form-floating form-floating-cus">
                                    ...
                                    <input type="email" class="form-control text-sm" id="email" name="dataOrder[email]" placeholder="Email" value="<?= (!empty($flash->has('email'))) ? $flash->get('email') : ((!empty($_SESSION[$loginMember]['email'])) ? $_SESSION[$loginMember]['email'] : '') ?>" required />
                            ...
                            <div class="input-cart">
                                ...
                                <div class="form-floating form-floating-cus">
                                    ...
                                    <input type="text" class="form-control text-sm" id="address" name="dataOrder[address]" placeholder="<?= diachi ?>" value="<?= (!empty($flash->has('address'))) ? $flash->get('address') : ((!empty($_SESSION[$loginMember]['address'])) ? $_SESSION[$loginMember]['address'] : '') ?>" required />
