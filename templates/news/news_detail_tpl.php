...
<div class="slider_albumdetail">

    <?php foreach ($rowDetailPhoto as $k => $v) { ?>

    <div class="item_albumdetail"><a href="">

            <img class="lazy w-100" onerror="this.src='<?= THUMBS ?>/500x500x1/assets/images/noimage.png';"
                data-src="<?= THUMBS ?>/500x500x1/<?= UPLOAD_NEWS_L . $v['photo'] ?>" alt="<?= $v['name' . $lang] ?>"
                title="<?= $v['name' . $lang] ?>" />
                    ...
                    <div class="news-other d-flex flex-wrap col-12 col-lg-12 col-md-6 box_newsdanhmuc">
                        ...
                        <a class="scale-img text-decoration-none pic-news-other" href="<?= $v[$sluglang] ?>"
                            ...
                            <img class="lazy w-100"
                                onerror="this.src='<?= THUMBS ?>/210x144x1/assets/images/noimage.png';"
