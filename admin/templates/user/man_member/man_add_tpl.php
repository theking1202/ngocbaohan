    ...
    <div class="container-fluid">
        <div class="row">
            <ol class="breadcrumb float-sm-left">
                ...
                <li class="breadcrumb-item active"><?=chitiettaikhoankhach?></li>
            </ol>
        </div>
    </div>
</section>
    ...
    <form class="validation-form" novalidate method="post" action="<?= $linkSave ?>" enctype="multipart/form-data">
        ...
        <div class="card card-primary card-outline text-sm">
            <div class="card-header">
                <h3 class="card-title"><?= ($act == "edit_member") ? capnhat : themmoi; ?> <?=taikhoan?></h3>
            </div>
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="password" class="form-control text-sm" name="data[password]" id="password" placeholder="<?=matkhau?>" <?= ($act == "add_member") ? 'required' : ''; ?>>
                    </div>
                    <div class="form-group col-md-4">
                        <label for="confirm_password"><?= nhaplaimatkhau?>:</label>
                        <input type="password" class="form-control text-sm" name="confirm_password" id="confirm_password" placeholder="<?=nhaplaimatkhau?>" <?= ($act == "add_member") ? 'required' : ''; ?>>
                    </div>
                    <div class="form-group col-md-4">
