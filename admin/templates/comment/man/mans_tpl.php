    ...
    <div class="container-fluid">
        <div class="row">
            <ol class="breadcrumb float-sm-left">
                ...
                <li class="breadcrumb-item active"><?=quanlybinhluan?> - <strong class="text-uppercase"><?= $item['namevi'] ?></strong></li>
            </ol>
        </div>
    </div>
</section>
...
<section class="content">
    <div class="card-footer text-sm sticky-top">
        <a class="btn btn-sm bg-gradient-danger mr-1" href="<?= $linkMan ?>" title="<?=thoat?>"><i class="fas fa-sign-out-alt mr-2"></i><?=thoat?></a>
        <a class="btn btn-sm bg-gradient-primary mr-1" href="<?= $configBase . $item['slugvi'] ?>" target="_blank" title="<?= $item['namevi'] ?>"><i class="far fa-eye mr-1"></i><?=xemchitiet?></a>
    </div>
    ...
    <div class="row">
        <div class="col-xl-3">
            <div class="card card-primary card-outline text-sm">
                <div class="card-header">
                    <h3 class="card-title"><?=danhgiatrungbinh?></h3>
                </div>
                <div class="card-body">
                    <div class="comment-avg-point mb-4">
                        <div class="text-center">
                            ...
                            <div class="comment-count"><a>(<?= $comment->total ?> <?=nhanxet?>)</a></div>
                        </div>
                    </div>
        ...
        <div class="col-xl-9">
            <div class="card card-primary card-outline text-sm">
                <div class="card-header">
                    <h3 class="card-title"><?=danhsachbinhluan?></h3>
                </div>
                        ...
                        <div class="comment-lists">
                            ...
                            <?php if ($comment->total > $comment->limitParentShow) { ?>
                                <div class="comment-load-more-control text-center mt-4">
                                    ...
                                    <button class="btn btn-sm btn-primary btn-load-more-comment-parent rounded-0 w-100 font-weight-bold py-2 px-3" href="javascript:void(0)" title="<?=taithembinhluan?>"><?=taithembinhluan?></button>
                                </div>
                            <?php } ?>
                        </div>
                    <?php } ?>
