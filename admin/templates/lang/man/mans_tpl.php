<?php
$linkCreate = "index.php?com=lang&type=".$type."&act=create";
$linkMan = "index.php?com=lang&type=".$type."&act=man";
$linkAdd = "index.php?com=lang&type=".$type."&act=add";
$linkEdit = "index.php?com=lang&type=".$type."&act=edit";
$linkDelete = "index.php?com=lang&type=".$type."&act=delete";
