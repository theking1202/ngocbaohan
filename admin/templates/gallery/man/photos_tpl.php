    ...
    <div class="container-fluid">
        <div class="row">
            <ol class="breadcrumb float-sm-left">
                ...
                <li class="breadcrumb-item active"><?= $config[$com][$type][$dfgallery][$val]['title_main_photo'] ?></li>
            </ol>
        </div>
    </div>
</section>
...
<section class="content">
    <div class="card-footer text-sm sticky-top">
        ...
        <a class="btn btn-sm bg-gradient-secondary" href="<?= $linkParent ?>" title="<?=thoat?>"><i class="fas fa-sign-out-alt mr-2"></i><?=thoat?></a>
    </div>
    <div class="card card-primary card-outline text-sm mb-0">
        <div class="card-header">
            <h3 class="card-title"><?=danhsach?> <?= $config[$com][$type][$dfgallery][$val]['title_main_photo'] ?></h3>
        </div>
