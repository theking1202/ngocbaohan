                            ...
                            <?php foreach ($config['website']['lang'] as $k => $v) { ?>
                                ...
                                <div class="tab-pane fade show <?= ($k == 'vi') ? 'active' : '' ?>" id="tabs-lang-<?= $k ?>" role="tabpanel" aria-labelledby="tabs-lang">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label for="name<?= $k ?>">Loại vàng:</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label for="gia">Giá vàng:</label>

                                        <input type="text" class="form-control for-seo text-sm format-price" name="data[gia]" id="gia" placeholder="Giá vàng" value="<?= (!empty($flash->has('gia'))) ? $flash->get('gia') : @$item['gia'] ?>" required>
