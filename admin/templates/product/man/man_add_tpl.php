                            ...
                            <div class="form-group-category row">
                                ...
                                <?php if (isset($config['product'][$type]['brand']) && $config['product'][$type]['brand'] == true) { ?>
                                    ...
                                    <div class="form-group col-xl-6 col-sm-4">
                                        ...
                                        <?= $func->getAjaxCategory('product', 'brand', $type, 'Chọn danh mục') ?>
                                ...
                                <?php if (isset($config['product'][$type]['size']) && $config['product'][$type]['size'] == true) { ?>
                                    ...
                                    <div class="form-group col-xl-6 col-sm-4">
                                        ...
                                        <label class="d-block" for="id_size">Loại vàng:</label>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <label class="d-block" for="trong_luong">Trọng lượng (lượng):</label>

                                <div class="input-group">

                                    <input type="text" class="form-control text-sm"

                                           name="data[trong_luong]" id="trong_luong" placeholder="Trọng lượng"

                                           value="<?= (!empty($flash->has('trong_luong'))) ? $flash->get('trong_luong') : @$item['trong_luong'] ?>">

                                    <div class="input-group-append">

                                        <div class="input-group-text"><strong>Lượng</strong></div>
...
<!--                                <div class="form-group col-md-6">-->
<!---->
<!--                                    <label class="d-block" for="sale_price">--><?php //= giamoi ?><!--:</label>-->
<!---->
<!--                                    <div class="input-group">-->
<!---->
<!--                                        <input type="text" class="form-control format-price sale_price text-sm"-->
<!---->
<!--                                            name="data[sale_price]" id="sale_price" placeholder="--><?php //= giamoi ?><!--"-->
<!---->
<!--                                            value="--><?php //= (!empty($flash->has('sale_price'))) ? $flash->get('sale_price') : @$item['sale_price'] ?><!--">-->
<!---->
<!--                                        <div class="input-group-append">-->
<!---->
<!--                                            <div class="input-group-text"><strong>VNĐ</strong></div>-->
