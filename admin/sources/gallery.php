...
function editPhoto()
{
    ...
    if (empty($id)) {
        $func->transfer(khongnhanduocdulieu, "index.php?com=" . $com . "&act=man_photo&id_parent=" . $id_parent . "&type=" . $type . "&kind=" . $kind . "&val=" . $val . "&p=" . $curPage, false);
    } else {
        ...
        if (empty($item)) {
            $func->transfer(dulieukhongcothuc, "index.php?com=" . $com . "&act=man_photo&id_parent=" . $id_parent . "&type=" . $type . "&kind=" . $kind . "&val=" . $val . "&p=" . $curPage, false);
        }
    }
}
...
function savePhoto()
{
    ...
    if ($id) {
        ...
        if ($d->update('gallery', $data)) {
            ...
            $func->transfer(capnhatdulieuthanhcong, "index.php?com=" . $com . "&act=man_photo&id_parent=" . $id_parent . "&type=" . $type . "&kind=" . $kind . "&val=" . $val . "&p=" . $curPage);
        } else {
            $func->transfer(capnhatdulieubiloi, "index.php?com=" . $com . "&act=man_photo&id_parent=" . $id_parent . "&type=" . $type . "&kind=" . $kind . "&val=" . $val . "&p=" . $curPage, false);
        }
    } else {
            ...
            for ($i = 0; $i < count($dataMultiTemp); $i++) {
                ...
                if ($success_file || $success_photo || $success_video) {
                    if ($d->insert('gallery', $dataMulti)) {
                        ...
                        $func->transfer(luudulieuthatbai, "index.php?com=" . $com . "&act=man_photo&id_parent=" . $id_parent . "&type=" . $type . "&kind=" . $kind . "&val=" . $val . "&p=" . $curPage, false);
                    }
                }
            }

            if ($success) {
                $func->transfer(luudulieuthanhcong, "index.php?com=" . $com . "&act=man_photo&id_parent=" . $id_parent . "&type=" . $type . "&kind=" . $kind . "&val=" . $val . "&p=" . $curPage);
            } else {
                $func->transfer(luudulieuthatbai, "index.php?com=" . $com . "&act=man_photo&id_parent=" . $id_parent . "&type=" . $type . "&kind=" . $kind . "&val=" . $val . "&p=" . $curPage, false);
            }
        } else {
            $func->transfer(dulieurong, "index.php?com=" . $com . "&act=man_photo&id_parent=" . $id_parent . "&type=" . $type . "&kind=" . $kind . "&val=" . $val . "&p=" . $curPage, false);
        }
    }
}
...
function deletePhoto()
{
    ...
    if ($id) {
        ...
        if (!empty($row)) {
            ...
            $func->transfer(xoadulieuthanhcong, "index.php?com=" . $com . "&act=man_photo&id_parent=" . $id_parent . "&type=" . $type . "&kind=" . $kind . "&val=" . $val . "&p=" . $curPage);
        } else {
            $func->transfer(xoadulieubiloi, dulieukhongcothuc, "index.php?com=" . $com . "&act=man_photo&id_parent=" . $id_parent . "&type=" . $type . "&kind=" . $kind . "&val=" . $val . "&p=" . $curPage, false);
        }
